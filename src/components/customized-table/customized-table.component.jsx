...
const rows = [
  ...
  createData('Compliance: R42012 TC failed, lorem ipsum lorem lorem lorem', 'QL0002', 'Blocker', 'Resolved'),
  createData('Switch] [GSG1] - Title does not display a confirmation while taking user to main menu.', 'QL0003', 'Minor','Resolved'),
  createData('QL_PS4_4Functionality_Confusing confirm and cancel buttons present in the UI', 'QL0004', 'Minor', 'Resolved'),
  createData('QL_PS4_xFunctionality_Larry and Yanmei voices are overlapping before the intercourse scene', 'QL0004', 'Minor', 'Open'),
  createData('Functionality1: Missing Collision with a wall, can causing falling through the map', 'QL0001', 'Blocker', 'Open'),
